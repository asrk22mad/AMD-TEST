...
<!-- Mirrored from ss64.com/nt/ by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 03 Apr 2013 06:37:55 GMT -->
...
<meta name="Keywords" content="Command line, Commands, Windows7, Windows 2008">
<link rel="alternate" type="application/rss+xml" title="RSS" href="http://ss64.com/rss.xml">
</head><body>
<div id="nav-menu"><ul>
<li><a class="rl" href="http://ss64.com/index.html"><img src="../images/ss64.gif" title="Home" alt="Home"></a></li>
<li><form action="http://www.google.com/search" method="get" style="margin:0px;padding:0px;">
<input type="text" name="q" id="question" size="25" maxlength="255">
<input type="submit" class="submit" value="Search" id="btn">
<input type="hidden" name="sitesearch" value="ss64.com">
</form></li>
<li><a class="rr" href="syntax.html"><img src="../images/syntax-r.gif" title="XP Syntax" alt="XP Syntax"></a></li>
<li><a class="rr" href="http://ss64.com/links/windows.html"><img src="../images/links-r.gif" title="CMD Scripting Books, Websites etc" alt="CMD Scripting Books, Websites etc"></a></li></ul>
</div> 
...
<pre>   <a href="addusers.html">ADDUSERS</a> Add or list users to/from a CSV file
   ...
   <a href="assoc.html">ASSOC</a>    Change file extension associations&bull;
   <a href="associate.html">ASSOCIAT</a> One step file association
   <a href="at.html">AT</a>       Schedule a command to run at a specific time
...
c
   ...
   <a href="call.html">CALL</a>     Call one batch program from another&bull;
   ...
   <a href="cd.html">CD</a>       Change Directory - move to a specific Folder&bull;
   ...
   <a href="copy.html">COPY</a>     Copy one or more files to another location&bull;
...
d
   <a href="date.html">DATE</a>     Display or set the date&bull;
   <a href="defrag.html">DEFRAG</a>   Defragment hard drive
   <a href="del.html">DEL</a>      Delete one or more files&bull;
   ...
   <a href="dir.html">DIR</a>      Display a list of files and folders&bull;
...
e
   <a href="echo.html">ECHO</a>     Display message on screen&bull;
   <a href="endlocal.html">ENDLOCAL</a> End localisation of environment changes in a batch file&bull;
   <a href="del.html">ERASE</a>    Delete one or more files&bull;
   <a href="eventcreate.html">EVENTCREATE</a> Add a message to the Windows event log
   <a href="exit.html">EXIT</a>     Quit the current script/routine and set an errorlevel&bull;
...
f
   ...
   <a href="for_f.html">FOR /F</a>   Loop command: against a set of files&bull;
   <a href="for_cmd.html">FOR /F</a>   Loop command: against the results of another command&bull;
   <a href="for.html">FOR</a>      Loop command: all options Files, Directory, List&bull;
   ...
   <a href="ftype.html">FTYPE</a>    File extension file type associations&bull;
g
   <a href="getmac.html">GETMAC</a>   Display the Media Access Control (MAC) address
   <a href="global.html">GLOBAL</a>   Display membership of global groups
   <a href="goto.html">GOTO</a>     Direct a batch program to jump to a labelled line&bull;
...
i
   ...
   <a href="if.html">IF</a>       Conditionally perform a command&bull;
   <a href="ifmember.html">IFMEMBER</a> Is the current user a member of a Workgroup
   <a href="ipconfig.html">IPCONFIG</a> Configure IP
k
   <a href="kill.html">KILL</a>     Remove a program from memory
l
   <a href="label.html">LABEL</a>    Edit a disk label
   <a href="local.html">LOCAL</a>    Display membership of local groups
   <a href="logevent.html">LOGEVENT</a> Write text to the event viewer
   <a href="logman.html">LOGMAN</a>   Manage Performance Monitor
...
m
   ...
   <a href="md.html">MD</a>       Create new folders&bull;
   <a href="mklink.html">MKLINK</a>   Create a symbolic link (linkd) &bull;
   ...
   <a href="move.html">MOVE</a>     Move files from one folder to another&bull;
   ...
   <a href="mv.html">MV</a>       Copy in-use files
n
   ...
   <a href="netsvc.html">NETSVC</a>   Command-line Service Controller
...
p
   <a href="path.html">PATH</a>     Display or set a search path for executable files&bull;
   <a href="pathping.html">PATHPING</a> Trace route plus network latency and packet loss
   <a href="pause.html">PAUSE</a>    Suspend processing of a batch file and display a message&bull;
   ...
   <a href="popd.html">POPD</a>     Return to a previous directory saved by PUSHD&bull;
   ...
   <a href="prnmngr.html">PRNMNGR</a>  Add, delete, list printers set the default printer
   <a href="prompt.html">PROMPT</a>   Change the command prompt&bull;
   ...
   <a href="pushd.html">PUSHD</a>    Save and then change the current directory&bull;
q
...
r
   ...
   <a href="rem.html">REM</a>      Record comments (remarks) in a batch file&bull;
   <a href="ren.html">REN</a>      Rename a file or files&bull;
   ...
   <a href="rd.html">RD</a>       Delete folder(s)&bull;
...
s
   ...
   <a href="sclist.html">SCLIST</a>   Display Services
   <a href="set.html">SET</a>      Display, set, or remove session environment variables&bull;
   <a href="setlocal.html">SETLOCAL</a> Control the visibility of environment variables&bull;
   ...
   <a href="shift.html">SHIFT</a>    Shift the position of batch file parameters&bull;
   <a href="shortcut.html">SHORTCUT</a> Create a windows shortcut (.LNK file)
   <a href="showgrps.html">SHOWGRPS</a> List the Workgroups a user has joined
   <a href="showmbrs.html">SHOWMBRS</a> List the Users who are members of a Workgroup
   ...
   <a href="soon.html">SOON</a>     Schedule a command to run in the near future
   <a href="sort.html">SORT</a>     Sort input
   <a href="start.html">START</a>    Start a program, command or batch file&bull;
   <a href="su.html">SU</a>       Switch User
...
t
   ...
   <a href="taskkill.html">TASKKILL</a> Remove a running process from memory
   <a href="time.html">TIME</a>     Display or set the system time&bull;
   <a href="timeout.html">TIMEOUT</a>  Delay processing of a batch file
   <a href="title.html">TITLE</a>    Set the window title for a CMD.EXE session&bull;
   ...
   <a href="type.html">TYPE</a>     Display the contents of a text file&bull;
   <a href="typeperf.html">TypePerf</a> Write performance data to a log file
u
   USRSTAT  List domain usernames and last login
v
   <a href="ver.html">VER</a>      Display version information&bull;
   <a href="verify.html">VERIFY</a>   Verify that files have been saved&bull;
   <a href="vol.html">VOL</a>      Display a disk label&bull;
w
   ...
   <a href="winmsdp.html">WINMSDP</a>  Windows system report
...
x
   ...
   <a href="rem.html">::</a>       Comment / Remark&bull;
</pre>
<p>Commands marked &bull; are <i>Internal</i> commands only available within the CMD shell.<br>
All other commands (not marked with &bull;) are <i>external</i> commands.<br>
External commands 
may be used under 
the CMD shell, <a href="http://ss64.com/ps/">PowerShell</a>, or directly from <a href="syntax-run-commands.html">START-RUN</a>.</p>
<p>See also: <a href="commands.html">a categorized list of Windows CMD commands<br>
</a>Microsoft Help pages: <a href="http://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/ntcmds.mspx">Windows XP</a> - <a href="http://technet.microsoft.com/en-us/library/cc778084(WS.10).aspx">2003 Server</a> - <a href="http://technet.microsoft.com/en-us/library/cc772390(WS.10).aspx">2008 Server</a><br>
<a href="http://ss64.org/viewforum.php?id=2">Discussion forum</a><br>
<a href="http://ss64.com/links/windows.html">Links to other sites, books etc...</a><br>
</p><!-- #BeginLibraryItem "/Library/foot_menu.lbi" --><hr>
<p id="top"><a href="#"><img src="../images/top-4.gif" width="47" height="53" alt="Back to the Top" title="Back to the Top"></a></p>
<p class="tagline">&copy; Copyright <a href="http://ss64.com/">SS64.com</a> 1999-2013<br>
Some rights reserved<br>
</p>
<!-- #EndLibraryItem --></body>

<!-- Mirrored from ss64.com/nt/ by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 03 Apr 2013 06:40:14 GMT -->
</html>
